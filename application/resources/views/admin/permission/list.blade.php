...
@section('page_title', __('Quản lý phân quyền'))
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header font-weight-bold d-flex justify-content-between align-items-center">
                    <h4 class="card-title m-0">{{ __('Quản lý phân quyền') }}</h4>
                    <div class="form-search form-inline">
                        <form action="">
                            <input type="text" name="keyword" placeholder="Tìm kiếm phân quyền"
                    ...
                    <a href="{{ route('admin.permission.create') }}" class="btn btn-secondary">Thêm phân quyền</a>

                </div>
                <form action="{{ route('admin.permission.action') }}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="analytic">
                            ...
                            <table class="table table-bordered verticle-middle table-responsive-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col"> # </th>
                                        <th scope="col">Tên route phân quyền</th>
                                        <th scope="col">Tên hiển thị phân quyền</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary"
                                                        href="{{ route('admin.permission.edit', $v->id) }}"
                                                        role="button">Sửa</a>
                                                    <a class="btn btn-danger"
                                                        href="{{ route('admin.permission.delete', $v->id) }}"
                                                        role="button">Xoá</a>
                                                </td>
                                            </tr>
                                        @endforeach
