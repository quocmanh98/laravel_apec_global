...
@section('page_title', __('Quản lý chức vụ'))
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header font-weight-bold d-flex justify-content-between align-items-center">
                    <h4 class="card-title m-0">{{ __('Quản lý chức vụ') }}</h4>
                    <div class="form-search form-inline">
                        <form action="">
                            <input type="text" name="keyword" placeholder="Tìm kiếm chức vụ"
                    ...
                    <a href="{{ route('admin.position.add') }}" class="btn btn-secondary">Thêm chức vụ</a>

                </div>
                <form action="{{ route('admin.position.action') }}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="analytic">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary"
                                                        href="{{ route('admin.position.edit', $v->id) }}"
                                                        role="button">Sửa</a>
                                                    <a class="btn btn-danger"
                                                        href="{{ route('admin.position.delete', $v->id) }}"
                                                        role="button">Xoá</a>
                                                </td>
                                            </tr>
                                        @endforeach
