...
@section('page_title', __('Quản lý trình độ'))
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header font-weight-bold d-flex justify-content-between align-items-center">
                    <h4 class="card-title m-0">{{ __('Quản lý trình độ') }}</h4>
                    <div class="form-search form-inline">
                        <form action="">
                            <input type="text" name="keyword" placeholder="Tìm kiếm trình độ"
                    ...
                    <a href="{{ route('admin.level.add') }}" class="btn btn-secondary">Thêm trình độ</a>

                </div>
                <form action="{{ route('admin.level.action') }}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="analytic">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary"
                                                        href="{{ route('admin.level.edit', $v->id) }}"
                                                        role="button">Sửa</a>
                                                    <a class="btn btn-danger"
                                                        href="{{ route('admin.level.delete', $v->id) }}"
                                                        role="button">Xoá</a>
                                                </td>
                                            </tr>
                                        @endforeach
