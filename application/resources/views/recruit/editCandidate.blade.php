...
@section('page_title', __('Sửa hồ sơ ứng viên'))
...
@section('page')
    ...
    <form action="{{ route('recruit.updateCandidate', $user->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h1 class="m-auto">Sửa hồ sơ ứng viên</h1> <br>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class="form-group col-md-12">
                                            <label>Địa chỉ thường trú:</label> <label
                                                class="red">(*)</label>
                                                <textarea name="nguyenquan" id="textarea" cols="10" rows="2" class="form-control @error('nguyenquan') is-invalid @enderror">{!! $user->nguyen_quan !!}</textarea>
                                            @error('nguyenquan')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <div class='row'>
                                        <div class="form-group col-md-12">
                                            <label>Nơi ở hiện tại:</label> <label
                                                class="red">(*)</label>
                                                <textarea name="tamtru" id="textarea" cols="10" rows="3" class="form-control @error('tamtru') is-invalid @enderror">{!! $user->tam_tru !!}</textarea>
                                            @error('tamtru')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name='recruitment'
                                                ...
                                                value="{{ $user->recruitment }}" placeholder="Nhập vị trí ứng tuyển">
                                            @error('recruitment')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
