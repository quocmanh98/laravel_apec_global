    ...
    <div class="row">
        <div class="col-lg-4 col-xl-3">
            <ul class="list-group list-group-flush">
                <a href="{{ route('settings.general') }}" class="list-group-item active">@lang('Tất cả')</a>
                <a href="{{ route('settings.auth') }}" class="list-group-item">@lang('Xác thực')</a>
                <a href="{{ route('settings.notifications') }}" class="list-group-item">@lang('Thông báo')</a>
                <a href="{{ route('settings.mail') }}" class="list-group-item">@lang('Email')</a>
            </ul>
        </div>
            ...
            <form id="app_settings" method="POST" action="{{ route('settings.update') }}" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div>
                            <h3>@lang('Cài đặt chung')</h3> @lang('Định cấu hình cài đặt chung.')
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <img src="{{ option('app_logo-compact', asset('upload/default/logo-text.png')) }}"
                                    class="img-thumbnail rounded float-right" alt="">
                            </div>
                        </div>
                        <hr />
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <img src="{{ option('app_brand-title', asset('upload/default/logo-text.png')) }}"
                        ...
                        <div class="form-group row">
                            <div class="col">
                                ...
                                <textarea name="app_copyright" class="form-control">{!! option('app_copyright', "Copyright © <a href='/'>JUBAYED</a> 2021") !!}</textarea>
                            </div>
                        </div>
